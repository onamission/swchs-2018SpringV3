...
function DealToPlayers(){
    ...
    this.funcName = "DealToPlayers";
}

DealToPlayers.prototype = Object.create( DealService );
 ...
 */
DealToPlayers.prototype.dealCards = function( numberOfPlayers, startCardPosition, cardsToDealThisRound, howToDealThisRound, remainingDeck ){
