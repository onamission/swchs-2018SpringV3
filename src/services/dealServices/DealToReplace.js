...
function DealToReplace(){
    DealService.call( this );
    this.funcName = "DealToReplace";
}

DealToReplace.prototype = Object.create( DealService );
 ...
 */
DealToReplace.prototype.dealCards = function( numberOfPlayers, startCardPosition, cardsToDealThisRound, howToDealThisRound, remainingDeck, cardsToReplace ){
