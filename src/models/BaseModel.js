 ...
 * @memberof BaseModel
 */
BaseModel.prototype.getter = function getter( key, field ){
    var retVal =
        field && key ?
 ...
 * @memberof BaseModel
 */
BaseModel.prototype.getBy = function getBy( keyField, keyValue, field){
    if( !keyField ){
 ...
 * @memberof BaseModel
 */
BaseModel.prototype.sortBy = function sortBy( keyField, direction, type ){
    if( !keyField ){
        return new Error( 'No Key Field Provided' );
    }
