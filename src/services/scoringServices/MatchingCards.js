...
MatchingCards.prototype = Object.create( ScoringService );

MatchingCards.prototype.getScore = function( handScore ){
    var self = this;
    ...
    MatchingCards.prototype.processMatch = function( setsInHand, options, handScore ){
        var self = this;
        var data = pokerData.getData();
