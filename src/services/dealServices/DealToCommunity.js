...
function DealToCommunity(){
    DealService.call( this );
    this.funcName = "DealToCommunity";
}

DealToCommunity.prototype = Object.create( DealService.prototype );
 ...
 */
DealToCommunity.prototype.dealCards = function( numberOfPlayers,
    startCardPosition, cardsToDealThisRound, howToDealThisRound, remainingDeck ){
