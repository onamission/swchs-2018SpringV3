...
GameBoard.prototype.communityCardArea = function communityCardArea( communityCardCount ){
...
GameBoard.prototype.scoringKey = function scoringKey( ){
    var handScoring = new( require( '../../models/ScoreOfHand' ) ) ( ).getter();
...
GameBoard.prototype.getPlayers = function getPlayers( playerCount ){
    var players = [ "MY HAND" ];
...
GameBoard.prototype.playersCardArea = function playersCardArea( playerCount, playerCardCount ){
